...
module PreventionGraphHelpers
  ...
  def get_male_community_based_child_protection_committees_records
    Prevention.where("data -> 'male_community_based_child_protection_committee' IS NOT NULL")
  end
  ...
  def get_female_community_based_child_protection_committees_records
    Prevention.where("data -> 'female_community_based_child_protection_committee' IS NOT NULL")
  end
  ...
  def get_community_engagement_sessions_records
    Prevention.where("data -> 'community_engagement_session' IS NOT NULL")
  end
end
